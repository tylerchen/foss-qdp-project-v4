...
var requireConfig = {
	baseUrl : (ctx.length == 1 ? '' : ctx) + '/resource/modules', urlArgs : '_v=1.0.3', paths : {
		 ...
		 * common js
		 */
		qdp : "elementui-2.3.5/qdp", //
		version : "elementui-2.3.5/version", //
		encrypt : "encrypt/jsencrypt.min",
		/**
		 * define vue
		 */
		vue : "elementui-2.3.5/vue-2.5.16", //
		vuerouter : "elementui-2.3.5/vue-router-3.0.1", //
		vueresource : "elementui-2.3.5/vue-resource-1.5.0", //
		vuex : "elementui-2.3.5/vuex-3.0.1",//
		vuexsync : "elementui-2.3.5/vuex-router-sync-5.0.0", //
		vuerender : "elementui-2.3.5/vue-render", //
		vuel : "elementui-2.3.5/require-vuejs", //
		globalstate : "elementui-2.3.5/global-state", //
		ELEMENT : "elementui-2.3.5/elementui-2.3.5",//
		elementuicss : "elementui-2.3.5/elementui-2.3.5", //
		customcss : "elementui-2.3.5/custom", //
		iconcss : "elementui-2.3.5/elementui-ionicons"
	}, shim : {
		qdp : {
			exports : "qdp"
		}, vuerender : {
