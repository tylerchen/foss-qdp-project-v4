package com.foreveross.extension.activiti.rest;
...
public class DemoDataInitConfig {
    ...
    @PostConstruct
    public void init() {
        org.iff.infra.util.Logger.debug("Initializing demo workflow.");
        if (true) {
    ...
    protected void initDemoUsers() {
        createUser("admin", "Henry", "Yan", "000000", "henry.yan@kafeitu.me", "", Arrays.asList("user", "admin"), null);

        createUser("hruser", "Lili", "Zhang", "000000", "lili.zhang@kafeitu.me", "", Arrays.asList("hr", "user"), null);

        createUser("leaderuser", "Jhon", "Li", "000000", "jhon.li@kafeitu.me", "", Arrays.asList("deptLeader", "user"),
                null);
    ...
    protected void initProcessDefinitions() {
        ...
        if (deploymentList == null || deploymentList.isEmpty()) {
            repositoryService.createDeployment().name(deploymentName).addClasspathResource("diagrams/leave/leave.bpmn")
                    .addClasspathResource("diagrams/leave/leave.png").deploy();
        }
    }
